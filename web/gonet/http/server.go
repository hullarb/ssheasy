...
var (
	...
	// anything in the webssh/web/net/http package. Callers should not
...
// is preferred:
//    https://golang.org/pkg/webssh/web/net/http/#ResponseWriter
//    https://golang.org/pkg/webssh/web/net/http/#example_ResponseWriter_trailers
...
// relevantCaller searches the call stack for the first function outside of webssh/web/net/http.
...
func relevantCaller() runtime.Frame {
	...
	for {
		...
		if !strings.HasPrefix(frame.Function, "webssh/web/net/http.") {
			return frame
		}
		if !more {
			break
...
var ErrAbortHandler = errors.New("webssh/web/net/http: abort Handler")
...
func (w *response) Hijack() (rwc net.Conn, buf *bufio.ReadWriter, err error) {
	if w.handlerDone.isSet() {
		panic("webssh/web/net/http: Hijack called after ServeHTTP finished")
	}
	if w.wroteHeader {
		w.cw.flush()
	}
...
func (w *response) CloseNotify() <-chan bool {
	if w.handlerDone.isSet() {
		panic("webssh/web/net/http: CloseNotify called after ServeHTTP finished")
	}
