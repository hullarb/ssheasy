...
//
// Deprecated: Use the Server in package webssh/web/net/http instead.
...
// We should have deleted it before Go 1.
//
// Deprecated: Use Client or Transport in package webssh/web/net/http instead.
...
// We should have deleted it before Go 1.
//
// Deprecated: Use the Client or Transport in package webssh/web/net/http instead.
