...
// 		"webssh/web/net/http.(*Client).do":           true,
// 		"webssh/web/net/http.(*Transport).RoundTrip": true,

// 		// Verify these don't exist:
// 		"webssh/web/net/http.http2Server":           false,
// 		"webssh/web/net/http.(*Server).Serve":       false,
// 		"webssh/web/net/http.(*ServeMux).ServeHTTP": false,
// 		"webssh/web/net/http.DefaultServeMux":       false,
// 	}
...
// 	out, err := exec.Command(goTool, "test", "-short", "-tags=nethttpomithttp2", "webssh/web/net/http").CombinedOutput()
// 	if err != nil {
...
// 	t.Parallel()
// 	goTool := testenv.GoToolPath(t)
// 	out, err := exec.Command(goTool, "vet", "-tags=nethttpomithttp2", "webssh/web/net/http").CombinedOutput()
// 	if err != nil {
