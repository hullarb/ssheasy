...
// response, the webssh/web/net/http package adds a "Content-Length: 0" response
// header.
...
func TestHTTP10ConnectionHeader(t *testing.T) {
	...
	// webssh/web/net/http uses HTTP/1.1 for requests, so write requests manually
	tests := []struct {
