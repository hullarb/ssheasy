...
import (
	...
	"time"
	. "webssh/web/net/http"
	"webssh/web/net/http/httptest"
	"webssh/web/net/http/httputil"
)
...
func testWriteHeaderAfterWrite(t *testing.T, h2, hijack bool) {
	...
	wantLog := "http: superfluous response.WriteHeader call from webssh/web/net/http_test.testWriteHeaderAfterWrite.func1 (clientserver_test.go:"
	if hijack {
		wantLog = "http: response.WriteHeader on hijacked connection from webssh/web/net/http_test.testWriteHeaderAfterWrite.func1 (clientserver_test.go:"
	}
